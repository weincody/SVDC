...
def main(argv):
    ...
    try:
        ...
        print "python normIdealSim.py --s_ref <somatic bowtie reference root> --c_ref <cancer bowtie reference root> --s_reads <somatic reads bam> --c_reads <cancer reads bam>"
        sys.exit(2)
    for opt, arg in opts:
        if opt == "-h":
            print "python normIdealSim.py -s_ref <somatic bowtie reference root> -c_ref <cancer bowtie reference root> -s_reads <somatic reads bam> -c_reads <cancer reads bam>"
...
if __name__ == "__main__":
    ...
    run_socrates_S = "../Tools/Socrates/Socrates all ../Data/normIdealSim/" + canc_reads + " --bowtie2_db ../Data/normIdealSim/" + som_ref
    ...
    run_exportFlanks_S = "java exportFlanks ../Tools/Socrates/results_Socrates_paired_" + canc_reads_root + "* S > ../Data/normIdealSim/SomFlanks.fa"

    som_reads_root = som_reads[0:len(som_reads) - 4]
    run_exportFlanks_C = "java exportFlanks ../Tools/Socrates/results_Socrates_paired_" + som_reads_root + "* C > ../Data/normIdealSim/CancFlanks.fa"
    ...
    index_S = "../Tools/bowtie2-2.2.3/bowtie2-build ../Data/normIdealSim/SomFlanks.fa ../Data/normIdealSim/REF_SomFlanks"
    index_C = "../Tools/bowtie2-2.2.3/bowtie2-build ../Data/normIdealSim/CancFlanks.fa ../Data/normIdealSim/REF_CancFlanks"
    ...
    map_CtoS = "../Tools/bowtie2-2.2.3/bowtie2 -x ../Data/normIdealSim/REF_SomFlanks -c -f ../Data/normIdealSim/CancFlanks.fa > ../Data/normIdealSim/MAP_C_to_S.txt"
    map_StoC = "../Tools/bowtie2-2.2.3/bowtie2 -x ../Data/normIdealSim/REF_CancFlanks -c -f ../Data/normIdealSim/SomFlanks.fa > ../Data/normIdealSim/MAP_S_to_C.txt"
    ...
    run_exportMatches = 'java exportMatches ../Data/normIdealSim/MAP_C_to_S.txt ../Data/normIdealSim/MAP_S_to_C.txt'
